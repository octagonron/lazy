...
function App() {
  ...
  useEffect(() => {
    const loadKeybinds = async () => {
      try {
        ...
        console.error("Failed to load keybinds:", error instanceof Error ? error.message : String(error));
      }
    };
    ...
    const setAlwaysOnTop = async () => {
      try {
        ...
        console.error("Failed to set window always on top:", error instanceof Error ? error.message : String(error));
      }
    };
  ...
  const executeCommand = async () => {
    ...
    try {
      ...
      setCommandOutput(`Error executing command: ${error instanceof Error ? error.message : String(error)}`);
    }
  };
